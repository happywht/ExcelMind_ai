        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-800">{templateFile.name}</h2>
                <p className="text-sm text-slate-500">Word模板文件</p>
              </div>
            </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-80 bg-slate-50 border-r border-slate-200 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2">
            {templateFile.placeholders.map((placeholder, idx) => (
              <div
                key={idx}
                className="bg-white p-3 rounded-lg border border-slate-200 hover:border-orange-300 hover:shadow-md transition-all cursor-pointer group"
              >
                <div className="flex items-center justify-between">
                  <code className="text-sm font-mono text-orange-600 font-medium">
                    {placeholder}
                  </code>
                  <button
          ...
          <div className="p-4 border-t border-slate-200 bg-white">
            <button
              ...
              className="w-full py-2 bg-orange-500 text-white rounded-lg text-sm font-medium hover:bg-orange-600 transition-colors flex items-center justify-center gap-2"
            >
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="p-4 border-b border-slate-200 bg-white flex items-center justify-between">
            <h3 className="font-semibold text-slate-700">模板预览</h3>
