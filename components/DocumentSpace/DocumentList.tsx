        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-slate-800 text-lg">生成文档</span>
              <div className="flex items-center gap-2 text-xs text-slate-500 mt-0.5">
                <span>批量处理结果</span>
                <span className="w-1 h-1 rounded-full bg-slate-300"></span>
                <span>{statistics.totalDocs} 个文件</span>
                <span className="w-1 h-1 rounded-full bg-slate-300"></span>
                <span>{formatFileSize(statistics.totalSize)}</span>
                <span className="w-1 h-1 rounded-full bg-slate-300"></span>
                <span>平均耗时 {formatTime(statistics.avgTime)}</span>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="px-4 py-2 bg-emerald-500 text-white rounded-xl font-medium hover:bg-emerald-600 transition-all flex items-center gap-2 shadow-sm shadow-emerald-200"
          >
